...
free FireFox [SQLite
Manager](https://lazierthanthou.github.io/sqlite-manager/)
...
And to calculate the difference in hours between the current `DATETIME`
and a given `DATETIME` string, we could use the following SQLite
syntax:\
...
Another smaller project that uses `sqlite3` in Python would be smilite,
...
it out at: <https://github.com/rasbt/smilite>.
