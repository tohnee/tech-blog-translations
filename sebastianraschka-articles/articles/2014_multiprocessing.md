---
title: "Python Multiprocessing Introduction"
source: https://sebastianraschka.com/Articles/2014_multiprocessing.html
crawled: 2026-09-06
---

# Python Multiprocessing Introduction
...
I have a more detailed explanation [here](https://sebastianraschka.com/Articles/2014_deep_python.html#else-clauses-conditional-else-and-completion-else) in one of my blog-posts, but in a nutshell: In contrast to a conditional else (in combination with if-statements), the “completion else” is only executed if the preceding code block (here the `for`-loop) has finished.
...
Below, we will set up benchmarking functions for our serial and multiprocessing approach that we can pass to our `timeit` [benchmark](https://sebastianraschka.com/glossary/#benchmark "Benchmark") function.  
