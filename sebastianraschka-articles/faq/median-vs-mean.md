---
title: "When should one use median, as opposed to the mean or average?"
...
Now, if you data is skewed, you are likely more interested in computing the median, which is less susceptible to outliers and extreme values. Let’s consider a classic examples “salaries.” Here, I plotted [FGCU salary dataset from OpenData](https://web.archive.org/web/20150910074300/https://opendata.socrata.com/dataset/FGCU-salary-dataset/fjqw-ymup):
