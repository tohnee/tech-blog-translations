---
title: "What is Softmax regression and how is it related to Logistic regression?"
...
![](https://sebastianraschka.com/images/faq/softmax_regression/14.png) for each class j.

(Note that w\_j is the weight vector for the class *y=j*.)
