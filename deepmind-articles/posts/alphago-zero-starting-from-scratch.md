...
site: deepmind
date: 2017-10-18
authors: David Silver, Demis Hassabis
crawled: 2026-09-13
---
...
![A line graph showing the Elo rating comparison of AlphaGo versions over 40 days, with baseline dashed lines for AlphaGo Lee (at approximately 3500 Elo) and AlphaGo Master (at approximately 4750 Elo).](https://storage.googleapis.com/gdm-deepmind-com-prod-public/media/original_images/62266dad5dd02443ba577b4e_unnamed.gif)
...
![A bar chart comparing power consumption (TDP) across AlphaGo versions, showing a dramatic decrease from AlphaGo Fan (176 GPUs, over 40,000 TDP) and AlphaGo Lee (48 TPUs, approx. 10,000 TDP) down to AlphaGo Master (4 TPUs) and AlphaGo Zero (4 TPUs), which both require minimal power.](https://lh3.googleusercontent.com/QFTNOIvGY2KRrSUlpDXrX1mt5IKUOyMhPaBFjgA6uLsEYklpR1O758s8Se7-RU-KEW2WuKvhdxojmLGCf359C60TvyhmVmBqB39yGGpEqiWGIF-Nfg=w1440)

AlphaGo has become progressively more efficient thanks to hardware gains and more recently algorithmic advances

After just three days of self-play training, AlphaGo Zero emphatically defeated the previously [published version of AlphaGo](https://ai.googleblog.com/2016/01/alphago-mastering-ancient-game-of-go.html) - which had itself [defeated 18-time world champion Lee Sedol](https://deepmind.com/alphago-korea) - by 100 games to 0. After 40 days of self training, AlphaGo Zero became even stronger, outperforming the version of AlphaGo known as “Master”, which has defeated the world's best players and [world number one Ke Jie](https://deepmind.com/alphago-china).

![Bar chart comparing Elo ratings of different Go programs: Crazy Stone (approx. 1900), AlphaGo Fan (approx. 3100), AlphaGo Lee (approx. 3700), AlphaGo Master (approx. 4800), and AlphaGo Zero, which achieves the highest rating at over 5000.](https://lh3.googleusercontent.com/yq94Hk34eZy1mCKyTDtIkGeMyUD0Y2_-hfrFL3gS6GHFVfrJTZvkcsxt7kFWfo6NPGaYFe10FPydtNo9KTK_qbZW4W_Pnb6kSJlAidezrgU_M6zvmA8=w1440)
...
![A bar chart comparing the Elo ratings of different Go programs, showing AlphaGo Zero achieving the highest rating at over 5000.](https://storage.googleapis.com/gdm-deepmind-com-prod-public/media/original_images/62266eee4bfb80301e18f60b_Games.gif)
...
Download [AlphaGo Zero games](https://www.alphago-games.com/)
