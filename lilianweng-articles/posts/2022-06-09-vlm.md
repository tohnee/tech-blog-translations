...
date: 2022-06-09
tags: [language-model, vision-language-model, vision-model]
...
*Ablation study results of VisualBERT on NLVR. (Image source: Li et al. 2019 )*
...
*Ablation study results of SimVLM on VQA. (Image source: Wang et al. 2022 )*
...
*Illustration of how a causally masked language model works. (Image source: Aghajanyan, et al. 2022 )*
...
*Illustration of VC-GPT training framework. (Image source: Luo et al. 2022 )*
...
*Overview of CoCa training framework. (Image source: Yu & Wang et al., 2022 )*
...
*Pseudo code for CoCa architecture and training. (Image source: Yu & Wang et al., 2022 )*
