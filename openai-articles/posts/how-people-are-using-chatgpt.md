...
**Read the paper:** For the complete results, methodology, and robustness checks, see [the full working paper](https://www.nber.org/papers/w34255). We look forward to analyzing how these results may evolve as the product changes and new capabilities ship.
