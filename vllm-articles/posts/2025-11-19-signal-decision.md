...
[#ecosystem](https://vllm.ai/blog/tags/ecosystem)
...
- Healthcare: Add "medical\_imaging", "clinical\_trials", "pharmaceutical\_research"
- Finance: Add "risk\_modeling", "algorithmic\_trading", "regulatory\_compliance"
- Legal: Add "contract\_law", "intellectual\_property", "litigation\_support"
...
| **system\_prompt** | Inject custom instructions | Replace or insert mode, role customization |
| **header\_mutation** | Modify HTTP headers | Add/update/delete headers, metadata propagation |
