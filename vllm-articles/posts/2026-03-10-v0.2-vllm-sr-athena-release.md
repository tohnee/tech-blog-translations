...
In our three-way benchmark on **AMD Instinct MI300X** with the real router path **Envoy (:8801) -> ext\_proc -> SR (:50051)**, the end-to-end latency profile changed dramatically:
