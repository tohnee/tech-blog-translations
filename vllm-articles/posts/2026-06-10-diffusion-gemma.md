...
The vLLM Team and Google DeepMind Team

[#model](https://vllm.ai/blog/tags/model)[#ecosystem](https://vllm.ai/blog/tags/ecosystem)[#inference](https://vllm.ai/blog/tags/inference)

> **Tip:** Looking to deploy DiffusionGemma? See the [vLLM recipe](https://recipes.vllm.ai/Google/diffusiongemma-26B-A4B-it) for deployment instructions.
...
![Autoregressive vs. block diffusion](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/ar-vs-diffusion.svg)
...
![DiffusionGemma block sampling loop](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/sampling-loop-horizontal.svg)
...
![Block denoising in context](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/denoising-grid.svg)
...
![Self-conditioning](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/self-conditioning.svg)
...
![How DiffusionGemma plugs into vLLM's speculative-decoding stack](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/stack.svg)
...
![Dynamic per-sequence causal attention](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/per_seq_causal_attention.svg)
...
![Per-sequence sliding window attention](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/per_seq_sliding_window.svg)
...
![Generation throughput on H100 and H200: FP8 diffusion vs. autoregressive baselines](https://vllm.ai/blog-assets/figures/2026-06-10-diffusion-gemma/perf.svg)

Generation throughput on H100 and H200: FP8 diffusion vs. autoregressive baselines

Generation throughput on H100 and H200 — FP8 diffusion vs. autoregressive baselines. [repro commands](https://gist.github.com/LucasWilkinson/89185e4dc05d300df33a4ce030973911)
