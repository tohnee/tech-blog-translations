...
[#community](https://vllm.ai/blog/tags/community)[#ecosystem](https://vllm.ai/blog/tags/ecosystem)[#learning](https://vllm.ai/blog/tags/learning)

![](https://vllm.ai/blog-assets/figures/2026-06-03-deeplearning-ai-course/course-banner.png)

We're excited to announce, with Red Hat and [Andrew Ng](https://en.wikipedia.org/wiki/Andrew_Ng)'s [DeepLearning.AI](https://www.deeplearning.ai/), a hands-on course that walks through LLM fundamentals and the full *optimize, deploy, and benchmark* AI deployment lifecycle using vLLM and it's ecosystem of tools. It's called [Fast & Efficient LLM Inference with vLLM](https://www.deeplearning.ai/courses/fast-and-efficient-llm-inference-with-vllm), and it's available now!
