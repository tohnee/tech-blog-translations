...
[#disaggregation](https://vllm.ai/blog/tags/disaggregation)[#mamba](https://vllm.ai/blog/tags/mamba)
...
HMA bumps FA block\_size until it's bigger than Mamba's, then pads the Mamba rows (`+[pad]`) so both groups have equal page sizes in bytes, enabling the shared-tensor scheme.
