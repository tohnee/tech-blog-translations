...
[#hardware](https://vllm.ai/blog/tags/hardware)[#quantization](https://vllm.ai/blog/tags/quantization)[#performance](https://vllm.ai/blog/tags/performance)
...
> **Note:** This blog emphasizes architectural and deployment validation over peak-throughput tuning, and the results reflect reproducible baseline performance.
>
...
FP4 MoE models on Blackwell require you to explicitly set VLLM\_USE\_FLASHINFER\_MOE\_FP4=1 to enable the FlashInfer FP4 MoE kernel.
...
> **Tip:** To use `FP8`, switch to FP8 model weights and then use `VLLM_USE_FLASHINFER_MOE_FP8=1`.
...
> **Note:** **PD Disaggregation on vLLM v0.14.1**: To run PD disaggregation with vLLM v0.14.1, you need to manually apply the patch from [PR #32698](https://github.com/vllm-project/vllm/pull/32698).
