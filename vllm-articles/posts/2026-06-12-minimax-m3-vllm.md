...
[#minimax](https://vllm.ai/blog/tags/minimax)[#day-0-support](https://vllm.ai/blog/tags/day-0-support)[#moe](https://vllm.ai/blog/tags/moe)[#long-context](https://vllm.ai/blog/tags/long-context)
...
![Figure 1: MiniMax M3 day-0 support brings long-context, multimodal, sparse-attention serving to vLLM.](https://vllm.ai/blog-assets/figures/minimax-m3/hero-minimax-m3-vllm.svg)
...
![Figure 2: MiniMax Sparse Attention keeps local and global context available while selecting sparse 128-token KV blocks from a 1M-token history.](https://vllm.ai/blog-assets/figures/minimax-m3/msa-1m-context.svg)
...
![Figure 3: vLLM routes dense layers through standard attention and sparse layers through the MiniMax MSA backend.](https://vllm.ai/blog-assets/figures/minimax-m3/msa-backend-dispatch.svg?v=2)
...
![Figure 4: For MiniMax M3, CPU-side image and video preprocessing should hand ready tensors to the vLLM worker so GPU time is reserved for inference.](https://vllm.ai/blog-assets/figures/minimax-m3/multimodal-request-path.svg?v=2)
...
![Figure 5: KV-block-major prefill reuses selected KV blocks across queries, reducing redundant memory movement before the final LSE reduction.](https://vllm.ai/blog-assets/figures/minimax-m3/kv-block-major-prefill.svg)
...
![Figure 6: Release-candidate validation checks accuracy, throughput, and speculative decoding before public MiniMax M3 recipes are published.](https://vllm.ai/blog-assets/figures/minimax-m3/validation-dashboard.svg)
...
- **Disaggregated serving:** expand NIXL and prefill/decode disaggregation recipes for M3 traffic, building on the directions in [Large-Scale Serving with vLLM](https://vllm.ai/blog/2025-12-17-large-scale-serving).
...
- [Speculative Decoding in vLLM](https://vllm.ai/blog/2024-10-17-spec-decode) and [P-EAGLE](https://vllm.ai/blog/2026-03-13-p-eagle) for the draft-model path.
- [Large-Scale Serving with vLLM](https://vllm.ai/blog/2025-12-17-large-scale-serving), [KV Offloading Connector](https://vllm.ai/blog/2026-01-08-kv-offloading-connector), and [Moriio KV Connector](https://vllm.ai/blog/2026-04-07-moriio-kv-connector) for prefix reuse, KV movement, and disaggregated serving.
