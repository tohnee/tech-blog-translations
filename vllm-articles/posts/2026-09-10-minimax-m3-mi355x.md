...
AMD and Embedded LLM Teams

[#hardware](https://vllm.ai/blog/tags/hardware)[#performance](https://vllm.ai/blog/tags/performance)[#moe](https://vllm.ai/blog/tags/moe)[#speculative-decoding](https://vllm.ai/blog/tags/speculative-decoding)[#disaggregation](https://vllm.ai/blog/tags/disaggregation)

The [MiniMax M3 day-0 post](https://vllm.ai/blog/2026-06-12-minimax-m3-vllm) described the first working vLLM implementation: MiniMax Sparse Attention (MSA), multimodal inputs, reasoning and tool outputs, MXFP8 weights, and EAGLE3 on AMD Instinct MI355X.
...
![MiniMax M3 fixed-workload serving progress on AMD Instinct MI355X](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/hero-fixed-workload-progress.svg)

MiniMax M3 fixed-workload serving progress on AMD Instinct MI355X
...
![MiniMax M3 decode critical path and P/D system boundary](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/optimization-map.svg)

MiniMax M3 decode critical path and P/D system boundary
...
![How TP sharding changes the local GEMM shape and tile plan](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/local-shape-tile-selection.svg)

How TP sharding changes the local GEMM shape and tile plan
...
![MiniMax M3 shared-expert execution before and after fusion](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/shared-expert-fusion.svg)

MiniMax M3 shared-expert execution before and after fusion
...
![How vLLM adapts MiniMax M3 sparse blocks to AITER pages without copying KV data](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/sparse-page-adapter.svg)

How vLLM adapts MiniMax M3 sparse blocks to AITER pages without copying KV data
...
![QuickReduce configuration, eligibility, codec selection, and execution gates](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/quickreduce-dispatch-gates.svg)

QuickReduce configuration, eligibility, codec selection, and execution gates
...
After the request-level index batching described above, [InferenceX #2107](https://github.com/SemiAnalysisAI/InferenceX/pull/2107) found that the target's attention-backend setting did not configure the draft. Pinning TRITON\_ATTN inside the speculative config avoided the draft's slower fallback.
...
![Two independently tuned MiniMax M3 P/D system profiles](https://vllm.ai/blog-assets/figures/2026-09-10-minimax-m3-mi355x/pd-system-profiles.svg)

Two independently tuned MiniMax M3 P/D system profiles
