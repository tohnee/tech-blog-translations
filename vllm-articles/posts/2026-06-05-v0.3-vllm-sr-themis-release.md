...
![Figure 1: Themis turns signals, policy, operators, and model backends into one inspectable routing control plane.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/hero-v2.png)
...
![Figure 2: The release value is not one isolated feature. It is the connection between stable contracts, inspection, operations, serving, long context, and validation.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/release-value-map.png)
...
![Figure 3: Local YAML, CLI, dashboard, and Kubernetes now converge on the same canonical v0.3 config shape.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/config-contract.png)
...
![Figure 4: The routing contract is now visible as a pipeline from request evidence to signal, projection, decision, algorithm, model, and replay.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/routing-contract.png)
...
![Figure 5: SAAR keeps multi-turn agent sessions stable by combining router-owned session memory, hard locks, portability checks, switch economics, and replay diagnostics.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/session-aware-routing.png)
...
![Figure 6: Projections transform noisy signal evidence into named outputs that decisions can reference directly.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/projection-layer.png)
...
![Figure 7: The dashboard becomes a practical operator console for setup, topology inspection, logs, playground testing, replay, and model health.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/operator-console.png)
...
![Figure 8: The long-context path preserves the signal and bounds native memory by chunking mmBERT attention work.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/long-context-binding.png)
...
![Figure 9: Themis broadens the hardware backend map while keeping one routing control plane across NVIDIA CUDA, AMD ROCm, Intel OpenVINO, and CPU/local paths.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/hardware-backend-paths.png)
...
![Figure 10: The AMD release path validates serve, dashboard import, router health, model listing, ROCm backend serving, and routed requests as one flow.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/amd-validation-path.png)
...
![Figure 11: RouterArena leaderboard snapshot showing vLLM-SR back at #1 by weighted Arena Score.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/routerarena-leaderboard-vllm-sr.png)
...
![Figure 12: Hermes centers on a self-improving router that connects GPU-scale performance research, DSL recipe tuning, router evaluation, codebase updates, and encoder fine-tuning.](https://vllm.ai/blog-assets/figures/2026-06-01-v0.3-vllm-sr-themis-release/hermes-roadmap.png)
