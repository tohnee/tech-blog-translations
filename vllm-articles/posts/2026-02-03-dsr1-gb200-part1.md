...
[#large-scale-serving](https://vllm.ai/blog/tags/large-scale-serving)[#performance](https://vllm.ai/blog/tags/performance)[#hardware](https://vllm.ai/blog/tags/hardware)
...
![RoPE+Quant+Q Write Fusion in Decode](https://vllm.ai/blog-assets/figures/2026-02-03-dsr1-gb200/rope_quant_fusion_timeline.png)
...
![MLA and MoE throughput plateau at ~64K batch size](https://vllm.ai/blog-assets/figures/2026-02-03-dsr1-gb200/mla_trtllm_ragged_prefill_prefill.png)

MLA and MoE throughput plateau at ~64K batch size

![MLA and MoE throughput plateau at ~64K batch size](https://vllm.ai/blog-assets/figures/2026-02-03-dsr1-gb200/moe_flashinfer_trtllm_nvfp4_prefill.png)
...
![Reducing EP degree halves communication overhead](https://vllm.ai/blog-assets/figures/2026-02-03-dsr1-gb200/nccl_all_gather.png)

Reducing EP degree halves communication overhead

![Reducing EP degree halves communication overhead](https://vllm.ai/blog-assets/figures/2026-02-03-dsr1-gb200/nccl_reduce_scatter.png)
...
![Trace showing weight onload overlapping with layer execution](https://vllm.ai/blog-assets/figures/2026-02-03-dsr1-gb200/onloading_trace.png)
