...
[#hardware](https://vllm.ai/blog/tags/hardware)[#ecosystem](https://vllm.ai/blog/tags/ecosystem)
...
![Diagram comparing host-issued collectives on GPUs with a compiled Tenstorrent mesh program](https://vllm.ai/blog-assets/figures/2026-09-07-vllm-tt-plugin/mesh-vs-collectives.svg)
...
![Timeline comparing upstream token-budget steps with Tenstorrent phase-homogeneous steps](https://vllm.ai/blog-assets/figures/2026-09-07-vllm-tt-plugin/scheduling-phases.svg)
...
![Diagram comparing the abandoned multi-process DP design with the shipped single-process lane-DP design](https://vllm.ai/blog-assets/figures/2026-09-07-vllm-tt-plugin/lane-dp.svg)
...
![Timeline showing decode overlap through asynchronous host readback](https://vllm.ai/blog-assets/figures/2026-09-07-vllm-tt-plugin/async-decode.svg)
...
> **Note:** Setup currently performs a from-source vLLM build against **0.26.0** inside a tt-metal environment. Per-model commands, mesh shapes, and required environment variables are in the [plugin README](https://github.com/tenstorrent/vllm-tt-plugin) and the corresponding tt-metal model demos.
