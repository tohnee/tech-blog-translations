...
Alexandre Marques, Megan Flynn, Helen Zhao, Krishna Teja Chitty Venkata, Chibueze Ukachi (Red Hat AI)

[#speculators](https://vllm.ai/blog/tags/speculators)[#speculative\_decoding](https://vllm.ai/blog/tags/speculative_decoding)[#peagle](https://vllm.ai/blog/tags/peagle)[#dflash](https://vllm.ai/blog/tags/dflash)[#dspark](https://vllm.ai/blog/tags/dspark)
...
![Figure 1. Parallel drafting algorithms, such as P-EAGLE, DFlash and DSpark, provide significant performance gains when compared to autoregressive drafting algorithms such as EAGLE-3. Speculator models mentioned above can be found in the Speculators Collection at the RedHatAI HuggingFace Hub.](https://vllm.ai/blog-assets/figures/2026-07-28-speculators-parallel-drafting/compare_interactivity_qwen38b_math.png)

Figure 1. Parallel drafting algorithms, such as P-EAGLE, DFlash and DSpark, provide significant performance gains when compared to autoregressive drafting algorithms such as EAGLE-3. Speculator models mentioned above can be found in the Speculators Collection at the RedHatAI HuggingFace Hub.

![Figure 1. Parallel drafting algorithms, such as P-EAGLE, DFlash and DSpark, provide significant performance gains when compared to autoregressive drafting algorithms such as EAGLE-3. Speculator models mentioned above can be found in the Speculators Collection at the RedHatAI HuggingFace Hub.](https://vllm.ai/blog-assets/figures/2026-07-28-speculators-parallel-drafting/compare_interactivity_qwen330b_humaneval.png)

Figure 1. Parallel drafting algorithms, such as P-EAGLE, DFlash and DSpark, provide significant performance gains when compared to autoregressive drafting algorithms such as EAGLE-3. Speculator models mentioned above can be found in the Speculators Collection at the RedHatAI HuggingFace Hub.

![Figure 1. Parallel drafting algorithms, such as P-EAGLE, DFlash and DSpark, provide significant performance gains when compared to autoregressive drafting algorithms such as EAGLE-3. Speculator models mentioned above can be found in the Speculators Collection at the RedHatAI HuggingFace Hub.](https://vllm.ai/blog-assets/figures/2026-07-28-speculators-parallel-drafting/compare_interactivity_gemma431b_humaneval.png)
...
![Figure 2. Parallel drafting generates multiple draft tokens in a single step, whereas auto-regressive drafting generates one draft token per step.](https://vllm.ai/blog-assets/figures/2026-07-28-speculators-parallel-drafting/ar_vs_parallel.jpg)

Figure 2. Parallel drafting generates multiple draft tokens in a single step, whereas auto-regressive drafting generates one draft token per step.
...
![Figure 3. Comparison between P-EAGLE, DFlash and DSpark. P-EAGLE ingests hidden states from the verifier as part of the speculator model inputs. DFlash projects hidden states into KV-cache. DSpark builds on a DFlash backbone and adds sequential correction and confidence estimator.](https://vllm.ai/blog-assets/figures/2026-07-28-speculators-parallel-drafting/diagram.jpg)

Figure 3. Comparison between P-EAGLE, DFlash and DSpark. P-EAGLE ingests hidden states from the verifier as part of the speculator model inputs. DFlash projects hidden states into KV-cache. DSpark builds on a DFlash backbone and adds sequential correction and confidence estimator.
