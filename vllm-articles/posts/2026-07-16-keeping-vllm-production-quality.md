...
[#ci](https://vllm.ai/blog/tags/ci)[#performance](https://vllm.ai/blog/tags/performance)[#evaluation](https://vllm.ai/blog/tags/evaluation)[#release](https://vllm.ai/blog/tags/release)

![vLLM pull requests passing through CI, performance and accuracy evaluation, and release gates](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/00-production-quality-hero-airport.png)

vLLM pull requests passing through CI, performance and accuracy evaluation, and release gates
...
![vLLM CI flow from GitHub Actions checks to dynamically selected Buildkite jobs](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/01-ci-pipeline-and-selected-jobs.png)

vLLM CI flow from GitHub Actions checks to dynamically selected Buildkite jobs
...
![vLLM CI test groups and example jobs](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/02-ci-test-groups-266-jobs.png)

vLLM CI test groups and example jobs
...
![Shared container build stages for vLLM CI and releases](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/03-container-build-stages.png)

Shared container build stages for vLLM CI and releases
...
![Top-level dependencies compiled into a fully pinned package graph](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/04-pip-compiled-dependency-graph.png)

Top-level dependencies compiled into a fully pinned package graph
...
![vLLM CI runner queues across accelerator vendors and hardware types](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/05-accelerator-runner-fleet.png)

vLLM CI runner queues across accelerator vendors and hardware types
...
![A standalone Buildkite agent polling a runner queue and reporting results](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/06-standalone-buildkite-agent-flow.png)

A standalone Buildkite agent polling a runner queue and reporting results
...
![Buildkite Agent Stack for Kubernetes creating one pod per CI job](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/07-kubernetes-buildkite-agent-flow.png)

Buildkite Agent Stack for Kubernetes creating one pod per CI job
...
![Eight H200 GPUs partitioned into 56 Multi-Instance GPU slices](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/08-h200-mig-slices.png)

Eight H200 GPUs partitioned into 56 Multi-Instance GPU slices
...
![The CI dashboard showing main-branch health](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/08-main-branch-health.png)
...
![The CI analyzer bot reporting a regression and suggested revert](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/12-ci-analyzer-bot.png)

The CI analyzer bot reporting a regression and suggested revert
...
![A nightly vLLM workload running performance, accuracy, and function-calling evaluations](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/14-nightly-perf-eval-workload.png)

A nightly vLLM workload running performance, accuracy, and function-calling evaluations
...
![Performance history for gpt-oss 120B on H200](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/14-performance-trends.svg)
...
![Comparing two vLLM images in the performance dashboard](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/15-compare-view.png)

Comparing two vLLM images in the performance dashboard
...
![Inspecting an incorrect evaluation sample](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/16-accuracy-sample-debugging.svg)

Inspecting an incorrect evaluation sample
...
![The vLLM release candidate testing and publishing loop](https://vllm.ai/blog-assets/figures/2026-07-16-keeping-vllm-production-quality/18-release-candidate-loop.png)

The vLLM release candidate testing and publishing loop
