...
![Live Demo on AMD GPUs](https://vllm.ai/blog-assets/figures/semantic-router/mom-4.png)
...
| **fact\_check** | Identifies queries needing factual verification | 50-100ms |
| **user\_feedback** | Detects corrections, satisfaction, clarifications | 50-100ms |
