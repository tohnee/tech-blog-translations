...
[#large-scale-serving](https://vllm.ai/blog/tags/large-scale-serving)[#speculative-decoding](https://vllm.ai/blog/tags/speculative-decoding)
...
> **Note:** Block size for a standard transformer layer (non-MLA [[4]](#ref-4)) is computed as follows:
...
> **Note:** I've also experimented with `LMCache` [[11]](#ref-11), the fastest production-ready connector (uses NVIDIA's NIXL as the backend), but it's still at the bleeding edge and I ran into some bugs. Since much of its complexity lives in an external repo, `SharedStorageConnector` is a better choice for explanation.
