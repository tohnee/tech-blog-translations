...
![Figure 1: Fusion API turns model diversity into a vLLM-SR routing primitive: panel, judge, synthesis, trace.](https://vllm.ai/blog-assets/figures/2026-06-16-vllm-sr-fusion-api/hero-v2.png)
...
![Figure 2: Fusion is signal-driven in vLLM-SR. Auto routing can choose any decision; direct Fusion routing chooses among Fusion decisions only; request plugins override execution, not global policy.](https://vllm.ai/blog-assets/figures/2026-06-16-vllm-sr-fusion-api/fusion-entry-modes.png)
...
![Figure 3: Fusion is a decision, not a default. vLLM-SR uses policy to decide when the extra latency is worth it.](https://vllm.ai/blog-assets/figures/2026-06-16-vllm-sr-fusion-api/fusion-decision-not-default.png)
...
![Figure 4: Fusion uses explicit stage contracts so panel output, judge analysis, synthesis, and trace accounting stay inspectable.](https://vllm.ai/blog-assets/figures/2026-06-16-vllm-sr-fusion-api/fusion-stage-contracts.png)
