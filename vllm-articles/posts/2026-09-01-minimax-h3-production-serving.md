...
[#performance](https://vllm.ai/blog/tags/performance)[#large-scale-serving](https://vllm.ai/blog/tags/large-scale-serving)[#multimodal](https://vllm.ai/blog/tags/multimodal)[#vllm-omni](https://vllm.ai/blog/tags/vllm-omni)[#fastvideo](https://vllm.ai/blog/tags/fastvideo)[#fasth3](https://vllm.ai/blog/tags/fasth3)
...
**MiniMax-H3 model-card sample** · [Open MP4](https://huggingface.co/MiniMaxAI/MiniMax-H3/resolve/main/assets/t2va.mp4)

[Video]()

**vLLM-Omni baseline** · [Open MP4](https://vllm-project.github.io/assets/figures/2026-08-29-minimax-h3-production-serving/evidence/b300/trtllm_dense.mp4)
...
*Figure 3: Latency–memory Pareto frontier. *r* is the number of resident
DiT blocks. Filled points are non-dominated measurements; open points are
dominated. At *r* = 35, DLO lowers reported HBM by 37.5% for a 5.1%
latency cost; *r* = 0 is the minimum-memory endpoint.*
...
**5 seconds** · [Open MP4](https://vllm-project.github.io/assets/figures/2026-08-29-minimax-h3-production-serving/fast-h3-5s.mp4)

[Video]()

**10 seconds** · [Open MP4](https://vllm-project.github.io/assets/figures/2026-08-29-minimax-h3-production-serving/fast-h3-10s.mp4)

[Video]()

**15 seconds** · [Open MP4](https://vllm-project.github.io/assets/figures/2026-08-29-minimax-h3-production-serving/fast-h3-15s.mp4)
