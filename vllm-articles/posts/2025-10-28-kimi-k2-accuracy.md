...
[#model-support](https://vllm.ai/blog/tags/model-support)[#developer](https://vllm.ai/blog/tags/developer)
...
| Model Name | Provider | finish\_reason: stop | finish\_reason: tool\_calls | finish\_reason: others | Schema Validation Errors | Successful Tool Calls |
| --- | --- | --- | --- | --- | --- | --- |
...
| Model Name | finish\_reason: stop | finish\_reason: tool\_calls | finish\_reason: others | Schema Validation Errors | Successful Tool Calls |
| --- | --- | --- | --- | --- | --- |
