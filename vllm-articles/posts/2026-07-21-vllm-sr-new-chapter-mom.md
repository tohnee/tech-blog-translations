...
[#ecosystem](https://vllm.ai/blog/tags/ecosystem)[#mixture-of-models](https://vllm.ai/blog/tags/mixture-of-models)[#semantic-router](https://vllm.ai/blog/tags/semantic-router)
...
![Figure 1: A Mixture-of-Models turns a heterogeneous model portfolio into one model experience.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/hero.png)
...
![Figure 2: Each stage changed the unit of control: model, decision, system, session, and finally the complete model lifecycle.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/evolution.png)
...
![Figure 3: The white paper defines the programmable routing engine; the vision paper connects it to workload and physical pool design.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/research-arc.png)
...
![Figure 4: Before MoM, fragmented intelligence becomes application-side routing glue.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/fragmentation-before-mom.png)
...
![Figure 5: With MoM, the same fragmented resources become the internal realization of one model.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/fragmentation-after-mom.png)
...
![Figure 6: Selection is one MoM topology. Cascades, parallel fusion, and bounded workflows share the same model boundary.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/execution-topologies.png)
...
![Figure 7: Preferences are published as bounded, versioned model contracts—not hidden application-side routing presets.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/preference-models.png)
...
![Figure 8: A complete MoM spans four planes: artifact, learning, execution, and physical realization.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/four-planes.png)
...
![Figure 9: One stable model identity, from portable contract to attributable run.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/artifact-resolution-lifecycle.png)
...
![Figure 10: Composition gain is meaningful only under matched active compute, with quality reported alongside calls, tokens, cost, latency, and energy.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/matched-compute-evaluation.png)
...
![Figure 11: MoM is a closed lifecycle: train the allocation policy, evaluate the full system, execute it, and turn outcomes into the next validated version.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/mom-lifecycle.png)
...
![Figure 12: One logical model identity can be realized across developer, data-center, cloud, and edge hardware.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/portable-realizations.png)
...
![Figure 13: Four connected workstreams turn Mixture-of-Models from an execution pattern into the next model architecture.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/next-stage-roadmap.png)
...
![Figure 14: Building the MoM engine is an open systems problem that needs the full model and infrastructure community.](https://vllm.ai/blog-assets/figures/2026-07-21-vllm-sr-new-chapter/community.png)
