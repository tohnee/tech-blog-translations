...
author: "苏剑林"
category: "信息时代"
tags: ["优化", "attention", "优化器", "muon"]
url: "https://kexue.fm/archives/11126"
...
[![MaxLogit爆炸现象](https://kexue.fm/usr/uploads/2025/07/3626912260.png)](https://kexue.fm/usr/uploads/2025/07/3626912260.png "点击查看原图")
...
[![Moonlight的MaxLogit自动降了下来](https://kexue.fm/usr/uploads/2025/07/3150611957.png)](https://kexue.fm/usr/uploads/2025/07/3150611957.png "点击查看原图")
...
但很明显，对$\boldsymbol{W}_q,\boldsymbol{W}_k$进行事后缩放理论上是可行的，问题是什么时候缩放、缩放多少。终于，某天福至心灵之下，笔者总算反应过来：**MaxLogit本身就是触发缩放的最直接信号！**具体来说，当MaxLogit超过期望阈值$\tau$时，我们直接给$\boldsymbol{Q}\boldsymbol{K}^{\top}$乘上$\gamma = \tau / S_{\max}$，那么新的MaxLogit肯定就不超过$\tau$了。乘$\gamma$的操作，我们可以分别吸收到权重$\boldsymbol{Q}\boldsymbol{K}$的权重上去，于是我们得到初版QK-Clip：
$$\begin{aligned}
...
[![经过接近70k steps的Muon和QK-Clip拉锯战后，MaxLogit 主动降了下来](https://kexue.fm/usr/uploads/2025/07/550205001.png)](https://kexue.fm/usr/uploads/2025/07/550205001.png "点击查看原图")
...
[![Muon与Adam训练的模型权重奇异值熵（等价于有效秩）比较](https://kexue.fm/usr/uploads/2025/07/1022731099.png)](https://kexue.fm/usr/uploads/2025/07/1022731099.png "点击查看原图")
...
最后，QK-Clip这种根据某些信号手动制定更新规则的操作，一定程度上是受到了DeepSeek的[Loss-Free](https://kexue.fm/archives/10757)负载均衡策略的启发而悟到的，这里再次致敬DeepSeek！
