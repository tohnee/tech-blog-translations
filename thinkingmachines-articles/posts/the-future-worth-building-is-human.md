...
- **[We train strong models](/news/introducing-inkling/)**, advancing capabilities such as multimodal interaction and customizability. Sharp instruments extend human will, and human judgment needs to shape models that compete on the frontier.
- **[We build tools](https://thinkingmachines.ai/tinker/)** that enable people to make AI their own, customizing models to serve their unique needs. This includes the ability to train model weights.
- **[We develop interfaces](https://thinkingmachines.ai/blog/interaction-models/)** that broaden the communication channel between human and machine, allowing personal judgment to continuously influence the work of AI.
- **[We publish research](https://thinkingmachines.ai/blog/)** for the scientific community, because the power to shape AI requires deep understanding of how it’s made.
